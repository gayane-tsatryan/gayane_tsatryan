...
Programmer::Programmer(const employee &employee, string compSkills, unsigned int salary, unsigned int bonus, ProgrammerType programmerType, ProgrammerLevel programmerLevel, string company): employee(employee)
{
	_compSkills = compSkills;
	_salary = salary;
  _bonus = bouns;
  _programmerType = programmerType;
  _programmerLevel = programmerLevel;
  _company = company;
}
