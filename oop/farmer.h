...
public:
    ...
    farmer(const employee& employee, FarmerType farmerType, string ranchoAddress, int animalsCount, int petsCount);
    farmer(const employee& employee, FarmerType farmerType, string ranchoAddress, int areGreenHouse, int petsCount);
    farmer(const employee& employee, FarmerType farmerType, string ranchoAddress, int petsCount);
    farmer(const employee& employee, FarmerType farmerType, string ranchoAddress, int areGreenHouse);
    farmer(const employee& employee, FarmerType farmerType, string ranchoAddress, int animalsCount);
    ~farmer();
};
